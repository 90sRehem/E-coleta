...
import SuccessScreen from "../../components/modals/SuccessScreen"
import './styles.css'
...
const Createpoints = () => {
    ...
    async function handleSubmit(e: FormEvent) {
        ...
        await api
            ...
            .catch(() => {
                alert("Falha ao cadastrar ponto de coleta!")
            })
    }
    function handleCloseSuccessScreen() {
        history.push('/')
    }
        ...
        <div id="page-create-point">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <fieldset>
                    <legend>
                        ...
                        <span>Selecione uma ou mais itens abaixo</span>
                    </legend>
            ...
            {successScreen && (
                <SuccessScreen
                    ...
                    onCloseAction={handleCloseSuccessScreen}
                />
            )}
        </div>
    )
